...
## [6.1]{style="color:#d496d4"} Learning Outcome
...
## [6.2]{style="color:#d496d4"} Getting Started

### [6.2.1]{style="color:#d496d4"} Installing and launching R packages
...
## [6.3]{style="color:#d496d4"} Plotting Calendar Heatmap
...
### [6.3.1]{style="color:#d496d4"} The Data
...
### [6.3.2]{style="color:#d496d4"} Examining the data structure
...
### [6.3.3]{style="color:#d496d4"} Data Preparation
...
![](img/lubridate.pdf){fig-align="center" width="700" height="350"}
:::
...
### [6.3.4]{style="color:#d496d4"} Building the Calendar Heatmaps
...
### [6.3.5]{style="color:#d496d4"} Building Multiple Calendar Heatmaps

**Challenge:** Building multiple heatmaps for the top four countries with the highest number of attacks.

**EXAMPLE:** ![](img/image02.png)

### [6.3.6]{style="color:#d496d4"} Plotting Multiple Calendar Heatmaps
...
### [6.3.7]{style="color:#d496d4"} Plotting Multiple Calendar Heatmaps
...
## [6.4]{style="color:#d496d4"} Plotting Cycle Plot

In this section, you will learn how to plot a cycle plot showing the time-series patterns and trend of visitor arrivals from Vietnam programmatically by using ggplot2 functions.

**EXAMPLE** ![](img/image03.png)

### [6.4.1]{style="color:#d496d4"} Step 1: Data Import
...
### [6.4.2]{style="color:#d496d4"} Step 2: Deriving month and year fields
...
### [6.4.3]{style="color:#d496d4"} Step 4: Extracting the target country
...
### [6.4.4]{style="color:#d496d4"} Step 5: Computing year average arrivals by month
...
### [6.4.5]{style="color:#d496d4"} Step 6: Plotting the cycle plot
...
## [6.5]{style="color:#d496d4"} Plotting Slopegraph
...
### [6.5.1]{style="color:#d496d4"} Step 1: Data Import
...
### [6.5.2]{style="color:#d496d4"} Step 2: Plotting the slopegraph
