...
## [2.1]{style="color:#d496d4; background:none;"} Installing and Launching R Packages
...
## [2.2]{style="color:#d496d4; background:none;"} Importing The Data Set

We will use [Wine Quality Data Set](https://archive.ics.uci.edu/ml/datasets/wine+quality) from UCI Machine Learning Repository will be used. The data set consists of 13 variables and 6497 observations. For the purpose of this exercise, a given file called wine_quality and is in csv file format have been provided which consist of combined the red wine and white wine data.

We import the data using *read_csv()* of **readr** package.
...
# [3]{style="color:#d496d4; background:none;"} Building Correlation Matrix: `pairs()` method
...
## [3.1]{style="color:#d496d4; background:none;"} Building a basic correlation matrix
...
## [3.2]{style="color:#d496d4; background:none;"} Drawing only lower or upper corner
...
## [3.3]{style="color:#d496d4; background:none;"} Including with correlation coefficients
...
# [4]{style="color:#d496d4; background:none;"} Visualising Correlation Matrix: `ggcormat()`
...
##[4.1]{style="color:#d496d4; background:none;"} The basic plot
...
# [5]{style="color:#d496d4; background:none;"} Building multiple plots
...
# [6]{style="color:#d496d4; background:none;"} Visualising Correlation Matrix using **corrplot** Package
...
## [6.1]{style="color:#d496d4; background:none;"} Getting started with corrplot
...
## [6.2]{style="color:#d496d4; background:none;"} Working with visual geometrics
...
## [6.3]{style="color:#d496d4; background:none;"} Working with layout
...
# Add title and subtitle using base R title()
title(main = "Correlation Plot - Lower Type")
...
## [6.4]{style="color:#d496d4; background:none;"} Working with mixed layout
...
# Add title and subtitle using base R title()
title(main = "Correlation Plot Wine Quality Data")
```

Notice that argument *lower* and *upper* are used to define the visualisation method used. In this case ellipse is used to map the lower half of the corrgram and numerical matrix (i.e. number) is used to map the upper half of the corrgram. The argument *tl.pos*, on the other, is used to specify the placement of the axis label. Lastly, the *diag* argument is used to specify the glyph on the principal diagonal of the corrgram.

## [6.5]{style="color:#d496d4; background:none;"} Combining corrgram with the significant test
...
title(main = "Correlation Plot Wine Quality Data",
      sub = "Marking non-significant pairs at p < 0.05", )
```
## [6.6]{style="color:#d496d4; background:none;"} Reorder a corrgram
...
## [6.7]{style="color:#d496d4; background:none;"} Reordering a correlation matrix using **hclust**
