...
## [5.1]{style="color:#d496d4"} Overview
...
In this hands-on exercise, we will be using four network data modelling and visualization packages: igraph, tidygraph, ggraph and visNetwork. We will also use tidyverse and [lubridate](https://lubridate.tidyverse.org/), to handle and wrangling time data.
...
## [5.3]{style="color:#d496d4"} The Data

The data sets used in this hands-on exercise is from an oil exploration and extraction company. There are two data sets. One contains the nodes data and the other contains the edges (also know as link) data.

### [5.3.1]{style="color:#d496d4"} The nodes data

-   *GAStech_email_nodes.csv* which consist of the names, department and title of the 55 employees.

![](img/image1.jpg)

### [5.3.2]{style="color:#d496d4"} The edges data

-   *GAStech_email_edge-v2.csv* which consists of two weeks of 9063 emails correspondances between 55 employees.

![](img/image2.jpg)

### [5.3.3]{style="color:#d496d4"} Importing network data from files
...
### [5.3.4]{style="color:#d496d4"} Reviewing the imported data
...
### [5.3.5]{style="color:#d496d4"} Wrangling time
...
### [5.3.6]{style="color:#d496d4"} Reviewing the revised date fields
...
### [5.3.7]{style="color:#d496d4"} Wrangling attributes
...
### [5.3.8]{style="color:#d496d4"} Reviewing the revised edges file
...
## [5.4]{style="color:#d496d4"} Creating network objects using **tidygraph**
...
### [5.4.1]{style="color:#d496d4"} The **tbl_graph** object
...
### [5.4.2]{style="color:#d496d4"} The **dplyr** verbs in **tidygraph**
...
### [5.4.3]{style="color:#d496d4"} Using `tbl_graph()` to build tidygraph data model.
...
### [5.4.4]{style="color:#d496d4"} Reviewing the output tidygraph's graph object

```{r}
GAStech_graph
```

### [5.4.5]{style="color:#d496d4"} Reviewing the output tidygraph's graph object

-   The output above reveals that *GAStech_graph* is a tbl_graph object with 54 nodes and 4541 edges.
-   The command also prints the first six rows of "Node Data" and the first three of "Edge Data".
-   It states that the Node Data is **active**. The notion of an active tibble within a tbl_graph object makes it possible to manipulate the data in one tibble at a time.

### [5.4.6]{style="color:#d496d4"} Changing the active object
...
## [5.5]{style="color:#d496d4"} Plotting Static Network Graphs with **ggraph** package
...
### [5.5.1]{style="color:#d496d4"} Plotting a basic network graph
...
🎀 [**Let's explore**]{style="color:#d496d4"} Notice that this Basic Network Graph consist of the edge link and node points? What are they? Check them out in the tabs below
...
### [5.5.2]{style="color:#d496d4"} Changing the default network graph theme
...
### [5.5.3]{style="color:#d496d4"} Changing the coloring of the plot
...
🎀 [**For easy comparison**]{style="color:#d496d4"}
```{r}
#| echo: false
#| fig-width: 20
#| fig-height: 15
...
((LgLayout / KKLayout) | (DrLayout / GraphOpt) | (frLayout / StressLayout)) 

```


### [5.5.6]{style="color:#d496d4"} Modifying network nodes
...
### [5.5.7]{style="color:#d496d4"} Modifying edges
...
## [5.6]{style="color:#d496d4"} Creating facet graphs
...
### [5.6.1]{style="color:#d496d4"} Working with *facet_edges()*
...
### [5.6.2]{style="color:#d496d4"} Working with *facet_edges()*
...
### [5.6.3]{style="color:#d496d4"} A framed facet graph
...
### [5.6.4]{style="color:#d496d4"} Working with *facet_nodes()*

[*facet_nodes()*](https://ggraph.data-imaginist.com/reference/facet_nodes.html) 
...
## [5.7]{style="color:#d496d4"} Network Metrics Analysis

### [5.7.1]{style="color:#d496d4"} Computing centrality indices
...
::: 🎀 callout-note
For the principles and mathematics of these measure refer to *Chapter 7: Actor Prominence* of **A user’s guide to network analysis in R** by Luke, Douglas A (2015) to gain better understanding of theses network measures. 

*Available for free [here](https://link-springer-com.libproxy.smu.edu.sg/book/10.1007/978-3-319-23883-8)*
...
### [5.7.2]{style="color:#d496d4"} Visualising network metrics
...
### [5.7.3]{style="color:#d496d4"} Visualising Community
...
## [5.8]{style="color:#d496d4"} Building Interactive Network Graph with visNetwork
...
### [5.8.1]{style="color:#d496d4"} Data preparation
...
### [5.8.2]{style="color:#d496d4"} Plotting the first interactive network graph
...
### [5.8.3]{style="color:#d496d4"} Working with layout
...
### [5.8.4]{style="color:#d496d4"} Working with visual attributes - Nodes
...
### [5.8.5]{style="color:#d496d4"} Working with visual attributes - Edges
...
### [5.8.6]{style="color:#d496d4"} Interactivity
...
## [5.9]{style="color:#d496d4"} Reference
