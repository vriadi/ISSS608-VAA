...
-   Persons
    ...
    -   We observe that Davis is receiving messages from or sending to "Boss", he also observed giving instructions to Mako (a high-traffic vessel). It's plausible that Davis may play a hands-on operational role, where he is looped into the command chain, receives instructions from Boss, relays or enforces those orders to operatives (e.g., Mako, vessel contacts).
...
-   After Pseudonym Analysis
    -   Now that we’ve mapped likely roles behind pseudonyms, the story reveals covert orchestration, manipulation of governance, and strategic masking of identities:
        ...
        -   Real Individuals Are Embedded in the Scheme Davis is likely coordinating with vessels (e.g., Mako) and receiving instructions from Boss. His seemingly bureaucratic or neutral position is now suspect as central to execution.
