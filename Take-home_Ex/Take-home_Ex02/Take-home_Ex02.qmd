...
If you have yet to install pacman, install it by typing below in the Console:
...
::: {.nursebox .nurse data-latex="nurse"} {#glimpse} \#### **Observation** {.no-top-padding}

-   The each data set area already split to nodes and edges thus we will extract the edges and nodes tables.
...
::: {.nursebox .nurse data-latex="nurse"}{#obsv1}
