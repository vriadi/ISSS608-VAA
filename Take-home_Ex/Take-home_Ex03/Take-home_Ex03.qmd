...
author: "Reef Whisper Team - Nguyen Phuong Hoa, Nguyen Nguyen Ha (Summer), Vanessa Riadi"
date: "Jun 12, 2025"
...
**The first app**, [Temporal Pattern and Communication Network](#app1), will be based on Part 2 - [Vanessa's Take Home Exercise 2](https://isss608-vriadi.netlify.app/take-home_ex/take-home_ex02/take-home_ex02). Focuses on visual exploration of the intercepted communication metadata. The app will be divided into 4 main section that will be further detailed in [Chapter 4](#app1). It will be focusing on:
...
Most preparation have been done in [Vanessa's: Take Home Exercise 2](https://isss608-vriadi.netlify.app/take-home_ex/take-home_ex02/take-home_ex02).
...
Most preparation have been done in [Hoa's: Take Home Exercise 2](https://isss608-ay2024-25t.netlify.app/take-home_ex/take-home_ex02/take-home_ex02).

In this section we will prepare and test the specific R codes can be run in Shiny and return the correct output as expected.

### View on [![](/images/Posit_logo.png){height="20"}](https://vriadi.shinyapps.io/reefwhispers_app2/){target="_blank"}
...
-   **shiny**: Enables the development of interactive web applications directly within R.  
-   **dplyr** (from ⁠ tidyverse ⁠): Provides efficient tools for data manipulation using a consistent grammar.  
-   **ggplot2** (from ⁠ tidyverse ⁠): Facilitates elegant and customizable data visualizations based on the Grammar of Graphics.  
-   **visNetwork**: Generates interactive network visualizations powered by the ⁠ vis.js ⁠ JavaScript library.  
-   **plotly**: Converts static plots into interactive web-based graphics for enhanced user exploration.  
-   **lubridate**: Simplifies the handling and manipulation of date-time data.  
-   **stringr**: Offers a cohesive set of functions for working with strings.  
-   **readxl**: Allows for the direct import of Excel files into R.  
-   **janitor**: Provides convenient functions for data cleaning and preprocessing.  
-   **tidytext** and **stopwords**: Support text mining and natural language processing tasks by tokenizing text and filtering common stopwords.

### [4.3.6]{style="color:#d496d4; background:none;"} Test the specific R codes can be run

Most preparation have been done in [Summer's Take Home Exercise 2](https://summernguyenn.netlify.app/take-home_ex/take-home_ex02/take-home_ex02).

In this section we will prepare and test the specific R codes can be run in Shiny and return the correct output as expected.

### View on [![](/images/Posit_logo.png){height="20"}](https://vriadi.shinyapps.io/reefwhispers_app3/){target="_blank"}
