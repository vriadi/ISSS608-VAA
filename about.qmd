...
about:
  ...
  links:
    - icon: linkedin
      ...
      target: _blank
    - text: "<img src='/images/tableaubw.png' style='height:18.5px; vertical-align:top;'>  Tableau Public"
      href: https://public.tableau.com/app/profile/vanessa.riadi/vizzes
      target: _blank
    #- icon: github
      #text: Github
...
**Porsche Services Singapore** \| Singapore \| Feb 2025 - present\
**Digital Business Development Intern**\
• Support the roll out of Digital Service Hub products including internal Sales Funnel Excellence Web App (CRM solution) and Porsche E-commerce Shop.\
• Manage and collaborate with external vendors to develop and enhance the products by creating test scenarios, conducting User Acceptance Testing (UAT), and ensuring production readiness.\
• Defined and track OKRs using a data science framework to translate business goals into measurable KPIs, and initiated the development of a custom data export format with vendors to enable enhanced reporting on product usage and operational performance.\
• Identify system and operation gaps, recommend actionable strategies to improve deployment and market success across Growth Region V5 markets (SG, MY, TH, KR, JP, TW, NZ, AU).\
• Develop and deliver training materials and plans across markets to support product adoption.\
• Provide day-to-day operational support by troubleshooting system issues, escalating bugs, and coordinating resolutions with developers.
...
**Award:** **Pinnacle Award at CPFB Excellence Award 2024 (Nov 2024)** for enabling quicker implementation of government transfers through the Citizen Disbursement IT System achieving a 60% efficiency in user e\[ort and vendor costs per batch User Acceptance Testing (UAT).\
